...
export const zhCN = {
  ...
  shell: {
    ...
    hotkeyModePrompt: {
      title: '检查录音方式',
      body: '本版本默认改为“单击”触发。如果你之前改过快捷键触发方式，请到“录音”里手动确认一次。本次更新同时调整了快捷键方式的读取逻辑；如果你更习惯按住说话，可以切回“按住”。',
      later: '稍后提醒',
      openSettings: '去录音设置',
    },
  },
  ...
  settings: {
    ...
    recording: {
      ...
      hotkeyLabel: '录音快捷键',
      hotkeyDescAcc: '选择单击、按住或双击触发；快捷键可留空。',
      hotkeyDescNoAcc: '选择单击、按住或双击触发；快捷键可留空。',
      hotkeyRecording: '请按键...',
      hotkeyClear: '清除快捷键',
      hotkeySetStatus: '已设置：{{hotkey}}',
      hotkeyUnsetStatus: '未设置',
      modeLabel: '触发方式',
      keyLabel: '快捷键',
      modeDesc: '单击开始/停止录音；按住为按下开始、松开结束；双击需要连续按两次。',
      modeToggle: '单击',
      modeHold: '按住',
      modeDoubleClick: '双击',
      migrationNoticeTitle: '默认已改为单击触发',
      migrationNoticeDesc: '如果你之前改过快捷键触发方式，请在这里手动确认一次。本次更新调整了快捷键方式的默认值与读取逻辑；如果你更习惯按住说话，可以切回“按住”。',
      capsuleLabel: '录音胶囊',
