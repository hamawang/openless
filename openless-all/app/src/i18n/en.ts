...
export const en: typeof zhCN = {
  ...
  shell: {
    ...
    hotkeyModePrompt: {
      ...
      body: 'This version now defaults to Single. If you changed the hotkey trigger mode before, please open Recording settings and confirm it once. This update also adjusts how the hotkey mode preference is read; if you prefer hold-to-talk, switch it back to Hold.',
  ...
  settings: {
    ...
    recording: {
      ...
      hotkeyDescAcc: 'Choose single, hold, or double trigger; the hotkey can be left empty.',
      hotkeyDescNoAcc: 'Choose single, hold, or double trigger; the hotkey can be left empty.',
      hotkeyRecording: 'Press keys...',
      hotkeyClear: 'Clear hotkey',
      hotkeySetStatus: 'Set: {{hotkey}}',
      hotkeyUnsetStatus: 'Not set',
      modeLabel: 'Trigger mode',
      keyLabel: 'Hotkey',
      modeDesc: 'Single starts/stops recording. Hold starts on press and stops on release. Double requires two presses.',
      modeToggle: 'Single',
      modeHold: 'Hold',
      modeDoubleClick: 'Double',
      migrationNoticeTitle: 'Default recording mode is now Single',
      migrationNoticeDesc: 'If you changed the hotkey trigger mode before, please confirm it here once. This update changes both the default value and the preference-reading path; if you prefer hold-to-talk, switch it back to Hold.',
  ...
  hotkey: {
    ...
    unset: 'Not set',
    modeHoldSuffix: ' (hold)',
    modeToggleSuffix: ' (single)',
    modeDoubleClickSuffix: ' (double)',
    usageHold: 'Hold {{trigger}} to talk, release to stop.',
    usageToggle: 'Press {{trigger}} to start, press again to stop.',
    usageDoubleClick: 'Double-click {{trigger}} to start or stop recording.',
    adapter: {
